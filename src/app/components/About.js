...
function About(){
    ...
    <div className=" mt-14 flex flex-col gap-10 items-center justify-center mx-4 md:flex-row ">
        <motion.div initial={{x:-100,opacity:0}} whileInView={{x:0,opacity:1}} transition={{duration:1}} className="justify-center p-5 sm:p-3 h-full max-w-[600px] mx-auto">
          <Image className="rounded-full w-10/12 md:w-auto sm:w-1/2 md:rounded-lg lg:w-10/12 xl:w-1/2 lg:h-1/2 mx-auto"src="/AboutPhoto.png" alt="profile Photo" width={700} height={700} />
        </motion.div>
