...
<section className="container mt-20 mb-5 mx-auto">
    <div className="flex flex-col-reverse lg:flex-row items-center gap-5 py-5 lg:mx-32 mx-auto px-4">
      <div>
        ...
        <motion.div initial={{x:-100,opacity:0}} whileInView={{x:0,opacity:1}} transition={{duration:2,delay:0.7, type:"spring", stiffness:190}} >
        <Button title="Contact Me"/>
        </motion.div>       
       </div>
      <motion.div initial={{x:100,opacity:0}} whileInView={{x:0,opacity:1}} transition={{duration:1}} className="w-10/12 lg:w-6/12 lg:ml-48">
        <Image
          src="/profile.jpg"
